package cn.betatown.itplatform.security.entity;
 ...
 * @创建人：wyait @创建时间：2017-12-28 19:57 @version：V1.0
 */
public class RoleVO {
	...
	public String toString() {
		return "RoleVO{" + "id=" + id + ", roleName='" + roleName + '\'' + ", descpt='" + descpt + '\'' + ", code='"
				+ code + '\'' + ", insertUid=" + insertUid + ", insertTime=" + insertTime + ", rolePerms=" + rolePerms
				+ '}';
	}
}
