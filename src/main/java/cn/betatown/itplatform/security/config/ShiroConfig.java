...
import cn.betatown.itplatform.security.shiro.RetryLimitHashedCredentialsMatcher;
import cn.betatown.itplatform.security.shiro.ShiroRealm;
 ...
 * @创建人：wyait @创建时间：2017-12-12 18:51 @version：V1.0
 */
@Configuration
...
public class ShiroConfig {
	...
	/**
	 * ShiroFilterFactoryBean 处理拦截资源文件过滤器 </br>
	 * 1,配置shiro安全管理器接口securityManage; </br>
