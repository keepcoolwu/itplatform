package cn.betatown.itplatform.security.web.user;
...
import cn.betatown.itplatform.common.utils.ValidateUtil;
import cn.betatown.itplatform.security.entity.ResponseResult;
...
import cn.betatown.itplatform.security.service.AuthService;
import cn.betatown.itplatform.security.service.UserService;
import cn.betatown.itplatform.security.utils.IStatusMessage;
...
/**
 * @项目名称：wyait-manage
 * @包名：com.wyait.manage.web.user @类描述：
 * @创建人：wyait @创建时间：2017-12-31 14:22 @version：V1.0
 */
@Controller
@RequestMapping("/user")
public class UserController {
	...
	public ResponseResult login(UserDTO user,
		...
		try {
			...
			AuthenticationToken token = new UsernamePasswordToken(user.getMobile(),
	...
	/**
	 * 登录【使用redis和mysql实现，用户密码输错次数限制，和锁定解锁用户的功能//TODO】 该实现后续会提供！TODO
	 * 
	 * @param user
	 * @param rememberMe
	 * @return
	...
	@ResponseBody
	public ResponseResult sendMessage(@RequestParam("mobile") String mobile, @RequestParam("picCode") String picCode) {
	...
	@ResponseBody
	public ResponseResult updatePwd(@RequestParam("mobile") String mobile, @RequestParam("picCode") String picCode,
