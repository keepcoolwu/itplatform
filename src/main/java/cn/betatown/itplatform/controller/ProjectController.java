...
public class ProjectController {
	...
	public ResponseEntity<String> addProjectFile() {
	...
	public ResponseEntity<String> writeProjectFile(@PathVariable("batchNum") String batchNum) {
	...
	// http://localhost:8080/project/all/2/100
	@ResponseBody
